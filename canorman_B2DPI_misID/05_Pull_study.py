...
# parser.add_argument('-e', '--effshape')      # option that takes a value
# args = parser.parse_args()
# print(args.effshape)
# Efficiency_shape = args.effshape # "Legendre_2_2"

# if (Efficiency_shape == "Flat"):
#     print("Flat efficiency")
# elif (Efficiency_shape == "Legendre_2_2"):
#     print("Legendre_2_2 efficiency")
# else:
...
#     var_list.append("c01_DK_Kspipi_DD_Bplus")
#     pass
...
short_path = f"{date}/05_2_Full_Toys_B2Dpi_misID_varying_gamma"
...
toy_results = toy_results.query("(errors_dB > 0) & (errors_dB < 6)")
toy_results = toy_results.query("(errors_rb > 0.0054)")
