...
N_Free_coeff = 0 # int(args.NFreeCoeff) # "Legendre_2_2"
numbernormalisation  = 1000000 # args.numbernormalisation # "Legendre_2_2"

# Efficiency_shape = 
Efficiency_shape_gen = "Flat" # "Legendre_5_5"
...
########## CONDOR
plot_dir=f"/shared/scratch/rj23972/safety_net/tfpcbpggsz/canorman_B2DPI_misID/{date}/01_No_Efficiency_516MisID"
#########

# ####### NOT CONDOR
# plot_dir=f"{date}/01_No_Efficiency"
# ######
...
if (job_id < 10):
    shutil.copyfile('01_No_Efficiency.py', f'{plot_dir}/01_No_Efficiency.py')
    pass
...
B2Dpi_misID_Bminus_efficiency_variables  = efficiency_variables
B2Dpi_misID_Bplus_efficiency_variables   = efficiency_variables
...
components = {
    "CB2DK_D2KSPIPI_DD": [
        ...
        ["Dpi_Kspipi_misID", "SumCBShape" , Efficiency_shape_fit]
    ],
    "CB2DPI_D2KSPIPI_DD": [
...
###### FIX MISID B2DPI
input_variables["CB2DK_D2KSPIPI_DD"]["Dpi_Kspipi_misID"]["Bplus_model"]["xplus" ] = inputs["xxi"]*inputs["xplus"]  - inputs["yplus"]*inputs["yxi"]
input_variables["CB2DK_D2KSPIPI_DD"]["Dpi_Kspipi_misID"]["Bplus_model"]["xminus"] = inputs["xxi"]*inputs["xminus"] - inputs["yminus"]*inputs["yxi"]
input_variables["CB2DK_D2KSPIPI_DD"]["Dpi_Kspipi_misID"]["Bplus_model"]["yplus" ] = inputs["xxi"]*inputs["yplus"]  + inputs["xplus"]*inputs["yxi"]
input_variables["CB2DK_D2KSPIPI_DD"]["Dpi_Kspipi_misID"]["Bplus_model"]["yminus"] = inputs["xxi"]*inputs["yminus"] + inputs["xminus"]*inputs["yxi"]

input_variables["CB2DK_D2KSPIPI_DD"]["Dpi_Kspipi_misID"]["Bminus_model"]["xplus" ] = inputs["xxi"]*inputs["xplus"]  - inputs["yplus"]*inputs["yxi"]
input_variables["CB2DK_D2KSPIPI_DD"]["Dpi_Kspipi_misID"]["Bminus_model"]["xminus"] = inputs["xxi"]*inputs["xminus"] - inputs["yminus"]*inputs["yxi"]
input_variables["CB2DK_D2KSPIPI_DD"]["Dpi_Kspipi_misID"]["Bminus_model"]["yplus" ] = inputs["xxi"]*inputs["yplus"]  + inputs["xplus"]*inputs["yxi"]
input_variables["CB2DK_D2KSPIPI_DD"]["Dpi_Kspipi_misID"]["Bminus_model"]["yminus"] = inputs["xxi"]*inputs["yminus"] + inputs["xminus"]*inputs["yxi"]
