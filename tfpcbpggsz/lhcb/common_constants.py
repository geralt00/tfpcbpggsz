...
pathname_storage = "/dice/projects/LHCb/QMI/Gamma_measurement/" # - usually eos, tuples stored here
pathname_lhcb= str(importlib.resources.files('tfpcbpggsz').joinpath('lhcb')) 
