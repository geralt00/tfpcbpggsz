...
from tfpcbpggsz.generator.config import get_config
from tfpcbpggsz.generator.tensorflow_wrapper import tf, tf_version
...
class LazyCall:
    ...
    def as_dataset(self, batch=65000):
        ...
        if self.cached_file is not None:
            from tfpcbpggsz.generator.utils import create_dir
...
class LazyFile(LazyCall):
    ...
    def as_dataset(self, batch=65000):
        ...
        test_data = next(gen())
        from tfpcbpggsz.generator.wrap_function import _wrap_struct
