...
def prod_nll_dk_dd(x):
    ...
    sig_prob_p = nsig * pdfs_data[decay+'_p']['sig'](Bu_M[decay+'_p']) * prod_totalAmplitudeSquared_XY(1, amp_Data_dk_dd_p, ampbar_Data_dk_dd_p, x, pdfs_data[decay+'_p']['sig'], pdfs_data[decay+'_m']['sig'], Bu_M[decay+'_p'], Bu_M[decay+'_m'])
    sig_prob_m = nsig * pdfs_data[decay+'_m']['sig'](Bu_M[decay+'_m']) * prod_totalAmplitudeSquared_XY(-1, amp_Data_dk_dd_m, ampbar_Data_dk_dd_m, x, pdfs_data[decay+'_p']['sig'], pdfs_data[decay+'_m']['sig'], Bu_M[decay+'_p'], Bu_M[decay+'_m'])
    misid_prob_p = nmisid * pdfs_data[decay+'_p']['misid'](Bu_M[decay+'_p']) * prod_totalAmplitudeSquared_DPi_XY(1, amp_Data_dk_dd_p, ampbar_Data_dk_dd_p, x, pdfs_data[decay+'_p']['misid'], pdfs_data[decay+'_m']['misid'], Bu_M[decay+'_p'], Bu_M[decay+'_m'])
    misid_prob_m = nmisid * pdfs_data[decay+'_m']['misid'](Bu_M[decay+'_m']) * prod_totalAmplitudeSquared_DPi_XY(-1, amp_Data_dk_dd_m, ampbar_Data_dk_dd_m, x, pdfs_data[decay+'_p']['misid'], pdfs_data[decay+'_m']['misid'], Bu_M[decay+'_p'], Bu_M[decay+'_m'])
    comb_prob_p = ncomb * pdfs_data[decay+'_p']['comb'](Bu_M[decay+'_p']) * prod_comb(amp_Data_dk_dd_p, ampbar_Data_dk_dd_p, x, pdfs_data[decay+'_p'], Bu_M[decay+'_p'], fracDD=fracDD)
    comb_prob_m = ncomb * pdfs_data[decay+'_m']['comb'](Bu_M[decay+'_m']) * prod_comb(amp_Data_dk_dd_m, ampbar_Data_dk_dd_m, x, pdfs_data[decay+'_m'], Bu_M[decay+'_m'], fracDD=fracDD)
    low_prob_p = nlow * pdfs_data[decay+'_p']['low'](Bu_M[decay+'_p']) * prod_low(1, amp_Data_dk_dd_p, ampbar_Data_dk_dd_p, x, pdfs_data[decay+'_p'], Bu_M[decay+'_p'], type='low')
    low_prob_m = nlow * pdfs_data[decay+'_m']['low'](Bu_M[decay+'_m']) * prod_low(-1, amp_Data_dk_dd_m, ampbar_Data_dk_dd_m, x, pdfs_data[decay+'_m'], Bu_M[decay+'_m'], type='low')
    low_misID_prob_p =  nlow_misID * pdfs_data[decay+'_p']['low_misID'](Bu_M[decay+'_p']) * prod_low(1, amp_Data_dk_dd_p, ampbar_Data_dk_dd_p, x, pdfs_data[decay+'_p'], Bu_M[decay+'_p'], type='low_misID')
    low_misID_prob_m =  nlow_misID * pdfs_data[decay+'_m']['low_misID'](Bu_M[decay+'_m']) * prod_low(-1, amp_Data_dk_dd_m, ampbar_Data_dk_dd_m, x, pdfs_data[decay+'_m'], Bu_M[decay+'_m'], type='low_misID')
    low_Bs2DKPi_prob_p = nlow_Bs2DKPi * pdfs_data[decay+'_p']['low_Bs2DKPi'](Bu_M[decay+'_p']) * prod_low(1, amp_Data_dk_dd_p, ampbar_Data_dk_dd_p, x, pdfs_data[decay+'_p'], Bu_M[decay+'_p'], type='low_Bs2DKPi')
    low_Bs2DKPi_prob_m = nlow_Bs2DKPi * pdfs_data[decay+'_m']['low_Bs2DKPi'](Bu_M[decay+'_m']) * prod_low(-1, amp_Data_dk_dd_m, ampbar_Data_dk_dd_m, x, pdfs_data[decay+'_m'], Bu_M[decay+'_m'], type='low_Bs2DKPi')
    ...
    return (tf.reduce_sum( -2* ll_data_p) + tf.reduce_sum( -2*ll_data_m) + 2 * total_yield)
...
def prod_nll_dk_ll(x):
    ...
    sig_prob_p = nsig * pdfs_data[decay+'_p']['sig'](Bu_M[decay+'_p']) * prod_totalAmplitudeSquared_XY(1, amp_Data_dk_ll_p, ampbar_Data_dk_ll_p, x, pdfs_data[decay+'_p']['sig'], pdfs_data[decay+'_m']['sig'], Bu_M[decay+'_p'], Bu_M[decay+'_m'])
    sig_prob_m = nsig * pdfs_data[decay+'_m']['sig'](Bu_M[decay+'_m']) * prod_totalAmplitudeSquared_XY(-1, amp_Data_dk_ll_m, ampbar_Data_dk_ll_m, x, pdfs_data[decay+'_p']['sig'], pdfs_data[decay+'_m']['sig'], Bu_M[decay+'_p'], Bu_M[decay+'_m'])
    misid_prob_p = nmisid * pdfs_data[decay+'_p']['misid'](Bu_M[decay+'_p']) * prod_totalAmplitudeSquared_DPi_XY(1, amp_Data_dk_ll_p, ampbar_Data_dk_ll_p, x, pdfs_data[decay+'_p']['misid'], pdfs_data[decay+'_m']['misid'], Bu_M[decay+'_p'], Bu_M[decay+'_m'])
    misid_prob_m = nmisid * pdfs_data[decay+'_m']['misid'](Bu_M[decay+'_m']) * prod_totalAmplitudeSquared_DPi_XY(-1, amp_Data_dk_ll_m, ampbar_Data_dk_ll_m, x, pdfs_data[decay+'_p']['misid'], pdfs_data[decay+'_m']['misid'], Bu_M[decay+'_p'], Bu_M[decay+'_m'])
    comb_prob_p = ncomb * pdfs_data[decay+'_p']['comb'](Bu_M[decay+'_p']) * prod_comb(amp_Data_dk_ll_p, ampbar_Data_dk_ll_p, x, pdfs_data[decay+'_p'], Bu_M[decay+'_p'], fracDD=fracDD)
    comb_prob_m = ncomb * pdfs_data[decay+'_m']['comb'](Bu_M[decay+'_m']) * prod_comb(amp_Data_dk_ll_m, ampbar_Data_dk_ll_m, x, pdfs_data[decay+'_m'], Bu_M[decay+'_m'], fracDD=fracDD)
    low_prob_p = nlow * pdfs_data[decay+'_p']['low'](Bu_M[decay+'_p']) * prod_low(1, amp_Data_dk_ll_p, ampbar_Data_dk_ll_p, x, pdfs_data[decay+'_p'], Bu_M[decay+'_p'], type='low')
    low_prob_m = nlow * pdfs_data[decay+'_m']['low'](Bu_M[decay+'_m']) * prod_low(-1, amp_Data_dk_ll_m, ampbar_Data_dk_ll_m, x, pdfs_data[decay+'_m'], Bu_M[decay+'_m'], type='low')
    low_misID_prob_p =  nlow_misID * pdfs_data[decay+'_p']['low_misID'](Bu_M[decay+'_p']) * prod_low(1, amp_Data_dk_ll_p, ampbar_Data_dk_ll_p, x, pdfs_data[decay+'_p'], Bu_M[decay+'_p'], type='low_misID')
    low_misID_prob_m =  nlow_misID * pdfs_data[decay+'_m']['low_misID'](Bu_M[decay+'_m']) * prod_low(-1, amp_Data_dk_ll_m, ampbar_Data_dk_ll_m, x, pdfs_data[decay+'_m'], Bu_M[decay+'_m'], type='low_misID')
    low_Bs2DKPi_prob_p = nlow_Bs2DKPi * pdfs_data[decay+'_p']['low_Bs2DKPi'](Bu_M[decay+'_p']) * prod_low(1, amp_Data_dk_ll_p, ampbar_Data_dk_ll_p, x, pdfs_data[decay+'_p'], Bu_M[decay+'_p'], type='low_Bs2DKPi')
    low_Bs2DKPi_prob_m = nlow_Bs2DKPi * pdfs_data[decay+'_m']['low_Bs2DKPi'](Bu_M[decay+'_m']) * prod_low(-1, amp_Data_dk_ll_m, ampbar_Data_dk_ll_m, x, pdfs_data[decay+'_m'], Bu_M[decay+'_m'], type='low_Bs2DKPi')
...
def prod_nll_dpi_dd(x):
    ...
    sig_prob_p = nsig * pdfs_data[decay+'_p']['sig'](Bu_M[decay+'_p']) * prod_totalAmplitudeSquared_DPi_XY(1, amp_Data_dpi_dd_p, ampbar_Data_dpi_dd_p, x, pdfs_data[decay+'_p']['sig'], pdfs_data[decay+'_m']['sig'], Bu_M[decay+'_p'], Bu_M[decay+'_m'])
    sig_prob_m = nsig * pdfs_data[decay+'_m']['sig'](Bu_M[decay+'_m']) * prod_totalAmplitudeSquared_DPi_XY(-1, amp_Data_dpi_dd_m, ampbar_Data_dpi_dd_m, x, pdfs_data[decay+'_p']['sig'], pdfs_data[decay+'_m']['sig'], Bu_M[decay+'_p'], Bu_M[decay+'_m'])

    misid_prob_p = nmisid * pdfs_data[decay+'_p']['misid'](Bu_M[decay+'_p']) * prod_totalAmplitudeSquared_XY(1, amp_Data_dpi_dd_p, ampbar_Data_dpi_dd_p, x, pdfs_data[decay+'_p']['misid'], pdfs_data[decay+'_m']['misid'], Bu_M[decay+'_p'], Bu_M[decay+'_m'])
    misid_prob_m = nmisid * pdfs_data[decay+'_m']['misid'](Bu_M[decay+'_m']) * prod_totalAmplitudeSquared_XY(-1, amp_Data_dpi_dd_m, ampbar_Data_dpi_dd_m, x, pdfs_data[decay+'_p']['misid'], pdfs_data[decay+'_m']['misid'], Bu_M[decay+'_p'], Bu_M[decay+'_m'])
    comb_prob_p = ncomb * pdfs_data[decay+'_p']['comb'](Bu_M[decay+'_p']) * prod_comb(amp_Data_dpi_dd_p, ampbar_Data_dpi_dd_p, x, pdfs_data[decay+'_p'], Bu_M[decay+'_p'], fracDD=fracDD)
    comb_prob_m = ncomb * pdfs_data[decay+'_m']['comb'](Bu_M[decay+'_m']) * prod_comb(amp_Data_dpi_dd_m, ampbar_Data_dpi_dd_m, x, pdfs_data[decay+'_m'], Bu_M[decay+'_m'], fracDD=fracDD)
    low_prob_p = nlow * pdfs_data[decay+'_p']['low'](Bu_M[decay+'_p']) * prod_low(1, amp_Data_dpi_dd_p, ampbar_Data_dpi_dd_p, x, pdfs_data[decay+'_p'], Bu_M[decay+'_p'], type='low')
    low_prob_m = nlow * pdfs_data[decay+'_m']['low'](Bu_M[decay+'_m']) * prod_low(-1, amp_Data_dpi_dd_m, ampbar_Data_dpi_dd_m, x, pdfs_data[decay+'_m'], Bu_M[decay+'_m'], type='low')
...
def prod_nll_dpi_ll(x):
    ...
    sig_prob_p = nsig * pdfs_data[decay+'_p']['sig'](Bu_M[decay+'_p']) * prod_totalAmplitudeSquared_DPi_XY(1, amp_Data_dpi_ll_p, ampbar_Data_dpi_ll_p, x, pdfs_data[decay+'_p']['sig'], pdfs_data[decay+'_m']['sig'], Bu_M[decay+'_p'], Bu_M[decay+'_m'])
    sig_prob_m = nsig * pdfs_data[decay+'_m']['sig'](Bu_M[decay+'_m']) * prod_totalAmplitudeSquared_DPi_XY(-1, amp_Data_dpi_ll_m, ampbar_Data_dpi_ll_m, x, pdfs_data[decay+'_p']['sig'], pdfs_data[decay+'_m']['sig'], Bu_M[decay+'_p'], Bu_M[decay+'_m'])
    misid_prob_p = nmisid * pdfs_data[decay+'_p']['misid'](Bu_M[decay+'_p']) * prod_totalAmplitudeSquared_XY(1, amp_Data_dpi_ll_p, ampbar_Data_dpi_ll_p, x, pdfs_data[decay+'_p']['misid'], pdfs_data[decay+'_m']['misid'], Bu_M[decay+'_p'], Bu_M[decay+'_m'])
    misid_prob_m = nmisid * pdfs_data[decay+'_m']['misid'](Bu_M[decay+'_m']) * prod_totalAmplitudeSquared_XY(-1, amp_Data_dpi_ll_m, ampbar_Data_dpi_ll_m, x, pdfs_data[decay+'_p']['misid'], pdfs_data[decay+'_m']['misid'], Bu_M[decay+'_p'], Bu_M[decay+'_m'])
    comb_prob_p = ncomb * pdfs_data[decay+'_p']['comb'](Bu_M[decay+'_p']) * prod_comb(amp_Data_dpi_ll_p, ampbar_Data_dpi_ll_p, x, pdfs_data[decay+'_p'], Bu_M[decay+'_p'], fracDD=fracDD)
    comb_prob_m = ncomb * pdfs_data[decay+'_m']['comb'](Bu_M[decay+'_m']) * prod_comb(amp_Data_dpi_ll_m, ampbar_Data_dpi_ll_m, x, pdfs_data[decay+'_m'], Bu_M[decay+'_m'], fracDD=fracDD)
    low_prob_p = nlow * pdfs_data[decay+'_p']['low'](Bu_M[decay+'_p']) * prod_low(1, amp_Data_dpi_ll_p, ampbar_Data_dpi_ll_p, x, pdfs_data[decay+'_p'], Bu_M[decay+'_p'], type='low')
    low_prob_m = nlow * pdfs_data[decay+'_m']['low'](Bu_M[decay+'_m']) * prod_low(-1, amp_Data_dpi_ll_m, ampbar_Data_dpi_ll_m, x, pdfs_data[decay+'_m'], Bu_M[decay+'_m'], type='low')
...
def nll(x):
    ...
    print(prod_nll_dpi_dd(x1) + prod_nll_dpi_ll(x2) + prod_nll_dk_dd(x1) + prod_nll_dk_ll(x2))
