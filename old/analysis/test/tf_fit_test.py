...
def get_p4(decay="b2dpi", cut='', index=index):
    ...
    if cut == 'int':
        ...
        branch_names = ["_1_K0S0_E", "_1_K0S0_Px", "_1_K0S0_Py", "_1_K0S0_Pz",
                         ...
                         "_3_pi~_E", "_3_pi~_Px", "_3_pi~_Py", "_3_pi~_Pz"]
        if cut == 'p':
            file_name = f'/software/pc24403/PCBPGGSZ/outputs/toy/1x_test/{decay}_test_{index}.root:Bplus_DalitzEventList'
        else:
            file_name = f'/software/pc24403/PCBPGGSZ/outputs/toy/1x_test/{decay}_test_{index}.root:Bminus_DalitzEventList'
...
if update == True:
    ...
    for decay in ['DK_KsPiPi_LL', 'DK_KsPiPi_DD', 'DPi_KsPiPi_LL', 'DPi_KsPiPi_DD']:
        ...
        file_name = f'/software/pc24403/PCBPGGSZ/outputs/toy/1x_test/{new_decay}_test_{index}.root:Bplus_DalitzEventList'
        tree = up.open(file_name)
