...
def get_p4(decay="b2dpi", cut='', index=index):
    ...
    if cut == 'int':
        ...
        branch_names = ["_1_K0S0_E", "_1_K0S0_Px", "_1_K0S0_Py", "_1_K0S0_Pz",
                         ...
                         "_3_pi~_E", "_3_pi~_Px", "_3_pi~_Py", "_3_pi~_Pz"]
        if cut == 'p':
            file_name = f'/software/pc24403/PCBPGGSZ/outputs/toy/1x_test/Dbar/{decay}_test_{index}.root:Bplus_DalitzEventList'
#            file_name = f'/software/pc24403/PCBPGGSZ/outputs/toy/swap/{decay}_{comp}_{index}.root:Bplus_DalitzEventList'

        else:
            file_name = f'/software/pc24403/PCBPGGSZ/outputs/toy/1x_test/Dbar/{decay}_test_{index}.root:Bminus_DalitzEventList'
...
if update == True:
    ...
    for decay in ['DK_KsPiPi_LL', 'DK_KsPiPi_DD', 'DPi_KsPiPi_LL', 'DPi_KsPiPi_DD']:
        ...
        file_name = f'/software/pc24403/PCBPGGSZ/outputs/toy/1x_test/Dbar/{new_decay}_test_{index}.root:Bplus_DalitzEventList'
        tree = up.open(file_name)
...
logpath = '/dice/users/pc24403/BPGGSZ/sim_fit_Dbar_comb'
...
def prod_nll_dk_dd(x):
    ...
    comb_prob_p = ncomb * mass_pdfs[decay+'_p']['comb'] * prod_low(1, amp_Data_dk_dd_p, ampbar_Data_dk_dd_p, x, mass_pdfs[decay+'_p'], Bu_M[decay+'_p'], type='low')
    comb_prob_m = ncomb * mass_pdfs[decay+'_m']['comb'] * prod_low(-1, amp_Data_dk_dd_m, ampbar_Data_dk_dd_m, x, mass_pdfs[decay+'_m'], Bu_M[decay+'_m'], type='low')
    ...
    ll_data_p = clip_log((sig_prob_p/normalisation_Bplus) + (misid_prob_p/misid_normalisation_Bplus)  + (low_prob_p/low_normalisation_Bplus) + (low_misID_prob_p/low_normalisation_Bplus) + (low_Bs2DKPi_prob_p/low_normalisation_Bplus) + (comb_prob_p/low_normalisation_Bplus))
    ll_data_m = clip_log((sig_prob_m/normalisation_Bminus) + (misid_prob_m/misid_normalisation_Bminus) + (low_prob_m/low_normalisation_Bminus) + (low_misID_prob_m/low_normalisation_Bminus) + (low_Bs2DKPi_prob_m/low_normalisation_Bminus) + (comb_prob_m/low_normalisation_Bminus))
...
def prod_nll_dk_ll(x):
    ...
    comb_prob_p = ncomb * mass_pdfs[decay+'_p']['comb'] * prod_low(1, amp_Data_dk_ll_p, ampbar_Data_dk_ll_p, x, mass_pdfs[decay+'_p'], Bu_M[decay+'_p'], type='low')
    comb_prob_m = ncomb * mass_pdfs[decay+'_m']['comb'] * prod_low(-1, amp_Data_dk_ll_m, ampbar_Data_dk_ll_m, x, mass_pdfs[decay+'_m'], Bu_M[decay+'_m'], type='low')
...
def prod_nll_dpi_dd(x):
    ...
    comb_prob_p = ncomb * mass_pdfs[decay+'_p']['comb'] * prod_low(1, amp_Data_dpi_dd_p, ampbar_Data_dpi_dd_p, x, mass_pdfs[decay+'_p'], Bu_M[decay+'_p'], type='low')
    comb_prob_m = ncomb * mass_pdfs[decay+'_m']['comb'] * prod_low(-1, amp_Data_dpi_dd_m, ampbar_Data_dpi_dd_m, x, mass_pdfs[decay+'_m'], Bu_M[decay+'_m'], type='low')
    ...
    ll_data_p = clip_log((sig_prob_p/normalisation_Bplus) + (misid_prob_p/misid_normalisation_Bplus) +  (low_prob_p/low_normalisation_Bplus) + comb_prob_p/low_normalisation_Bplus)
    ll_data_m = clip_log((sig_prob_m/normalisation_Bminus) + (misid_prob_m/misid_normalisation_Bminus) +  (low_prob_m/low_normalisation_Bminus) + comb_prob_m/low_normalisation_Bminus)
...
def prod_nll_dpi_ll(x):
    ...
    comb_prob_p = ncomb * mass_pdfs[decay+'_p']['comb'] * prod_low(1, amp_Data_dpi_ll_p, ampbar_Data_dpi_ll_p, x, mass_pdfs[decay+'_p'], Bu_M[decay+'_p'], type='low')
    comb_prob_m = ncomb * mass_pdfs[decay+'_m']['comb'] * prod_low(-1, amp_Data_dpi_ll_m, ampbar_Data_dpi_ll_m, x, mass_pdfs[decay+'_m'], Bu_M[decay+'_m'], type='low')
