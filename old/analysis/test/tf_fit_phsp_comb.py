...
def prod_nll_dk_dd(x):
    ...
    comb_prob_p = ncomb * mass_pdfs[decay+'_p']['comb'] * prod_comb(amp_Data_dk_dd_p, ampbar_Data_dk_dd_p, misid_normA_m, misid_normAbar_p, fracDD=fracDD)
    comb_prob_m = ncomb * mass_pdfs[decay+'_m']['comb'] * prod_comb(amp_Data_dk_dd_m, ampbar_Data_dk_dd_m, misid_normA_m, misid_normAbar_p, fracDD=fracDD)
...
def prod_nll_dk_ll(x):
    ...
    comb_prob_p = ncomb * mass_pdfs[decay+'_p']['comb'] * prod_comb(amp_Data_dk_ll_p, ampbar_Data_dk_ll_p, misid_normA_m, misid_normAbar_p, fracDD=fracDD)
    comb_prob_m = ncomb * mass_pdfs[decay+'_m']['comb'] * prod_comb(amp_Data_dk_ll_m, ampbar_Data_dk_ll_m, misid_normA_m, misid_normAbar_p, fracDD=fracDD)
...
def prod_nll_dpi_dd(x):
    ...
    comb_prob_p = ncomb * mass_pdfs[decay+'_p']['comb'] * prod_comb(amp_Data_dpi_dd_p*eff[decay+'_m'], ampbar_Data_dpi_dd_p*eff[decay+'_p'], normA_m, normAbar_p, fracDD=fracDD)
    comb_prob_m = ncomb * mass_pdfs[decay+'_m']['comb'] * prod_comb(amp_Data_dpi_dd_m*eff[decay+'_m'], ampbar_Data_dpi_dd_m*eff[decay+'_p'], normA_m, normAbar_p, fracDD=fracDD)
    low_prob_p = eff[decay+'_p'] * nlow * mass_pdfs[decay+'_p']['low'] * prod_low(1, amp_Data_dpi_dd_p, ampbar_Data_dpi_dd_p, x, mass_pdfs[decay+'_p'], Bu_M[decay+'_p'], type='low')
    low_prob_m = eff[decay+'_m'] * nlow * mass_pdfs[decay+'_m']['low'] * prod_low(-1, amp_Data_dpi_dd_m, ampbar_Data_dpi_dd_m, x, mass_pdfs[decay+'_m'], Bu_M[decay+'_m'], type='low')
...
def prod_nll_dpi_ll(x):
    ...
    comb_prob_p = ncomb * mass_pdfs[decay+'_p']['comb'] * prod_comb(amp_Data_dpi_ll_p, ampbar_Data_dpi_ll_p, normA_m, normAbar_p, fracDD=fracDD)
    comb_prob_m = ncomb * mass_pdfs[decay+'_m']['comb'] * prod_comb(amp_Data_dpi_ll_m, ampbar_Data_dpi_ll_m, normA_m, normAbar_p, fracDD=fracDD)
