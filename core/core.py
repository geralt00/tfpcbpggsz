...
class fit:
    ...
    def __init__(self, config, params, minimizer='iminuit'):
    ...
    def nll(self, params):
        ...
        #        nll += self.prod_nll(decay+'_'+mag, params)
        
            
        return self.prod_nll('b2dpi_LL', params) + self.prod_nll('b2dpi_DD', params) + self.prod_nll('b2dk_LL', params) + self.prod_nll('b2dk_DD', params)
